...
<div style="padding: 20px 20px 10px;" class="wrapper">
	<s:form action="report_toadd" method="post">
		...
		<div><select name="server.county" id="county" class="width140" onchange="changeValue();">
				<option value="--">--</option>
		...
		<div>
			<div>
				...
				家庭人口：<input type="number" name="server.family_size" id="family_size" class="width50" maxlength="3">&nbsp;人，
				其中：劳动力人口&nbsp;<input type="number" name="server.workers_size" id="workers_size" class="width50" maxlength="3">&nbsp;人，
				低保人口&nbsp;<input type="number" name="server.dibao_size" id="dibao_size" class="width50" maxlength="3">&nbsp;人，
				五保人口&nbsp;<input type="number" name="server.wudao_size" id="wudao_size" class="width50" maxlength="3">&nbsp;人。
			</div>
			<div>
				贫困户属性：
				<input name="server.poverty_level1" type="checkbox">&nbsp;一般贫困户&nbsp;
				<input name="server.poverty_level2" type="checkbox">&nbsp;低保户&nbsp;
				<input name="server.poverty_level3" type="checkbox" id="poverty_level3">&nbsp;五保户&nbsp;
		...
		<table border="1" style='border:1px solid #aaa'>
			...
			<tr>
				...
				<td>如该户有劳动力，有一项以上增<br/>
					收致富主导产业计满分，无不得分<br/>
					如该户无劳动力，直接计满分</td>
				<td><input type="number" name="server1.scope12" id="scope12" class="width40" maxlength="2">
				</td>
			</tr>
			<tr>
				<td>家庭成员就业创业技能</td>
			...
			<tr>
				<td>上年人均可支配收入</td>
				<td>根据附表测算，约为&nbsp;<input type="text" name="server1.money1" id="money1" class="width120">&nbsp;元</td>
				<td>&nbsp;—&nbsp;</td>
				<td>&nbsp;—&nbsp;</td>
				<td>&nbsp;—&nbsp;</td>
			</tr>
			<tr>
				...
				<td>根据附表测算，约为&nbsp;<input type="text" name="server1.money2" id="money2" class="width120">&nbsp;元</td>
				<td>&nbsp;—&nbsp;</td>
				<td>&nbsp;—&nbsp;</td>
				<td>&nbsp;—&nbsp;</td>
			</tr>
			<tr>
				<td>是否超过同期国家扶贫标准（&nbsp;<input type="text" name="server1.fupinbz" id="fupinbz" value="4000" class="width80">&nbsp;元）：
			...
			<tr>
				<td>是否达到同期本县（市）农村居民人均可支配收入（&nbsp;<input type="text" name="server1.renjun" id="renjun" class="width80">&nbsp;元）的70%：<br/>
			...
			<tr>
				<td>该户低保、五保对象年人均保障性收入为&nbsp;<input type="text" name="server1.income" id="xxxxxxx" class="width80">&nbsp;
					元，是否超过同期国家扶贫标准：
			...
			<tr>
				...
				<td>增幅约为&nbsp;<input type="text" name="server1.increase" id="increase" class="width60">&nbsp;%（本年人均可支配收入/上年人均可支配收入-1）×100%</td>
				<td>&nbsp;—&nbsp;</td>
				<td>&nbsp;—&nbsp;</td>
				<td>&nbsp;—&nbsp;</td>
			</tr>
			<tr>
				<td>是否高于同期全省农村居民人均可支配收入平均增幅（&nbsp;
					<input type="text" name="server1.ave_increase" id="money2" class="width40" value="9.2">&nbsp;%）：
			...
			<tr>
				...
				<td>
					...
					<input name="server3.house_size" type="text" id="house_size" class="width50" maxlength="3">&nbsp;㎡/
					<input name="server3.family_n" type="number" id="family_n" class="width50" maxlength="3">&nbsp;人=
					<input name="server3.people_size" type="text" id="people_size" class="width50" maxlength="3">&nbsp;㎡/人）
				</td>
			...
			<tr>
				<td colspan="4">户主（签字）：<input type="text" name="server3.sign1" id="sign1" class="width80"></td>
			</tr>
			<tr>
				<td colspan="4">日期：
