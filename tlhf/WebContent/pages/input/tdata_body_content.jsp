...
<%-- 分页  添加一个div用于显示数据 --%>
								<div id="reportlist_show_div">
									<s:form action="tdata_query" method="post" id="reportlist_init_form" enctype="multipart/form-data">
...
<script type="text/javascript">
	$(function($) {
		...
		$("#btnNew").click(function() {
			$( "#dialog" ).OpenDialog({title:"录入服务",width:1080}, "tdata_toadd", "queryBean.pageIndex=<s:property value='queryBean.pageIndex'/>");
		});
		...
		$("#linkDel").click(function() {
			...
			$("#dialog").MsgBox("是否确认删除该条信息？", function() {
				$("#content").SubmitForm($("#reportlist_init_form"), "tdata_del", {"queryBean.pageIndex":"<s:property value='queryBean.pageIndex'/>", "id1.id" : id});
			});
		});
		...
		$("#linkUpd").click(function() {
			var id = $(this).attr("id");
			$( "#dialog" ).OpenDialog({title:"编辑",width:1080}, "tdata_updInit", {"queryBean.pageIndex":"<s:property value='queryBean.pageIndex'/>", "serverList.id" : id});
		});
	});
</script>