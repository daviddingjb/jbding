package com.trusdata.tlhf.energy.action;
...
import com.trusdata.tlhf.energy.bean.SetPactEnergyBean;
import com.trusdata.tlhf.energy.service.PactEnergyService;
 ...
 * 
 */
public class PactEnergyAction extends BasePageAction<PactSearchBean> {
	/**
	 * UID
	 */
	...
	public String add(PactEnergyBean server) {
		String rtn = "add";
		...
		try {
			...
			if (server == null) {
				...
				insert = SetPactEnergyBean.setBean(server);
	...
	public PactEnergyBean getEnergy() {
		return energy;
	}

	public void setEnergy(PactEnergyBean energy) {
		this.energy = energy;
	}
