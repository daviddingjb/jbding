package com.trusdata.tlhf.tdatajn.action;
...
import com.trusdata.tlhf.tdatajn.bean.SetPactTdataJnBean;
import com.trusdata.tlhf.tdatajn.service.PactTdataJnService;
 ...
 * 
 */
public class PactTdataJnAction extends BasePageAction<PactSearchBean> {
	/**
	 * UID
	 */
	...
	public String add(PactTdataJnBean server) {
		String rtn = "add";
		...
		try {
			...
			if (server == null) {
				...
				insert = SetPactTdataJnBean.setBean(server);
