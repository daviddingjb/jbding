...
(function() {
    ...
    angular
        ...
        .controller('GroupConfigureController', GroupConfigureController);

    function GroupConfigureController(PagerService,$scope) {
        var vm = this;
        $scope.numbers=[5,10,15,20];
        $scope.selectedNumber=$scope.numbers[0];

        vm.dummyItems =[
            {name: 'Hege', describe: "Pege",linkName: 'dfcas', targetName: "vsdv"},
            {name: 'Kim', describe: "Pim",linkName: 'asfsa', targetName: "gnbgf"},
            {name: 'Sal', describe: "Smith",linkName: 'fdgsde', targetName: "efrvge"},
            {name: 'Jack', describe: "Jones",linkName: 'sfvds', targetName: "jtry"},
            {name: 'Hege', describe: "Pege",linkName: 'dfcas', targetName: "vsdv"},
            {name: 'Kim', describe: "Pim",linkName: 'asfsa', targetName: "gnbgf"},
            {name: 'Sal', describe: "Smith",linkName: 'fdgsde', targetName: "efrvge"},
            {name: 'Jack', describe: "Jones",linkName: 'sfvds', targetName: "jtry"},
